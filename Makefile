BUILD = build
MAKEFILE = Makefile
OUTPUT_FILENAME = Reisen_im_Zentralkaukasus_und_Baschan
TITLE_NAME = "Reisen im Zentralkaukasus und Baschan"
...
PREFACE_EPUB = chapters/preface/titel_epub.md chapters/preface/00_Preface_epub.md
PREFACE_HTML_PDF = chapters/preface/titel_epub.md chapters/preface/00_Preface_pdf_html.md
